...
class Annunciator(ObjBase):
    ...
    def __init__(self, name: str, node: str, nodetype: str, nodeformat: str, nodeconds: dict, device: HT16K33, port: str, row: str, out1: str, nblight: str, activemode: str, initstate: str, debug=False) -> None:
        super().__init__(name, node, nodetype, nodeformat, nodeconds, debug)
        # ----- Object properties -----
